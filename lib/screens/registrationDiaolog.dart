...
class PopScreen extends StatefulWidget {
  const PopScreen({
    ...
    @required this.scafflodcontext,
  }) : super(key: key);

  final GlobalKey<ScaffoldState> scaffoldKey;
  final Event event;
  final TextStyle hintStyle;
  final BuildContext scafflodcontext;
...
//                   validator: validateEmail,
//                   decoration: InputDecoration(
//                       hintText: 'Enter Email', hintStyle: widget.hintStyle),
//                   onSaved: (String value) {
//                     setState(() {
//                       temp['email'] = value;
//                       // temp['phonenum'] = value;
...
//                   },
//                   decoration: InputDecoration(
//                       hintText: 'Enter Teammate Names with "," separated',
//                       hintStyle: widget.hintStyle),
//                   onSaved: (String value) {
//                     setState(() {
//                       temp['teamNames'] = value;
...
//                   },
//                   decoration: InputDecoration(
//                       hintText: 'Enter Name', hintStyle: widget.hintStyle),
//                  onSaved: (String value) {
//                     setState(() {
//                       temp['name'] = value;
//                       // temp['phonenum'] = value;
